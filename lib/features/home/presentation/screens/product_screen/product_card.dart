                    ...
                    Positioned(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            padding: EdgeInsets.all(10.rSp),
                            child: DefaultText(
                              title: '- ${offer!.replaceAll('-', '').replaceAll('%', '')} %',
                              style: Style.small,
                              fontWeight: FontWeight.w700,
                              maxLines: 1,
                              fontSize: 8.rSp,
                          ...
                          Row(
                            children: [
                              if(offerType == 1)
                                ...
                                title: '${(((100 - double.parse(offer!.replaceAll('-', '').replaceAll('%', ''))) / 100) * double.parse(newPrice)).toStringAsFixed(2)} ${appBloc.translationModel!.currency}',
                                fontSize: 10.rSp,
                                fontWeight: FontWeight.w700,
                                color: ColorsManager.mainColor,
                                style: Style.medium ,
