...
import 'package:exponile_customer/features/home/presentation/screens/categories/store_category_details.dart';
              ...
              child: SizedBox(
                ...
                RefreshIndicator(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child:homeCubit.categoriesEntity != null && homeCubit.categoriesEntity!.data.storeCats.isNotEmpty ?
                    Column(
                      children: [
                        verticalSpace(2.h),
                        AnimationLimiter(
                                  ...
                                  child: FadeInAnimation(
                                    child: Column(
                                      children: [
                                        InkWell(
                                          onTap: () {
                                            navigateTo(context, StoreCategoryDetails(
                                                storeCategorySlug: homeCubit.categoriesEntity!.data.storeCats[index].slug
                                            )
                                            );
                                          },
                                          child: Row(
                                            children: [
                                              SizedBox(
                                                ...
                                                child: CachedNetworkImage(
                                                  imageUrl: homeCubit.categoriesEntity!.data.storeCats[index].bannerPath,
                                              ...
                                              Expanded(
                                                child: DefaultText(
                                                  title: homeCubit.categoriesEntity!.data.storeCats[index].name,
